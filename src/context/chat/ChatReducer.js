    ...
    switch(action.type){
        ...
        case types.nuevoMensaje:
            ...
            if(state.chatActivo === action.payload.de || 
               state.chatActivo === action.payload.para){ //Si el uid del chatActivo es igual al uid de la persona que me envia el mensaje.
        ...
        case types.notificacionMensaje:
            ...
            if(action.payload.de || 
                action.payload.para){ //Si el uid del chatActivo es igual al uid de la persona que me envia el mensaje.
